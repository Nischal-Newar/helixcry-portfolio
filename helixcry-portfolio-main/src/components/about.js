                        ...
                        aboutProfileData.map((item) => (
                            ...
                            <Card className="about-profile-item" bg="dark">
                                <Card.Body as="div">
                                    ...
                                    <Card.Text as="p">
                                        <a href={item.linkedIn} target="_blank"><AiFillLinkedin/></a>
                                        <a href={item.steam} target="_blank"><SiSteam/></a>
                                        <a href={item.github} target="_blank"><AiFillGithub/></a>
                                        <a href={item.medium} target="_blank"><AiFillMediumCircle/></a>
                                    </Card.Text>
                                </Card.Body>
                            </Card>
                            </Col>
